...
I chose to use english as the coding- and documentation language. I did this because I assume it is the standard within Xledger. I also chose to keep the number of code files to two for each exercise. One for tests and one for the solution. The solutions can be found in src/exercises and the tests can be found in src/tests.
